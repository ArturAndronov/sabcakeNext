...
export type Translations = {
    [key: string]: {
        ...
        buttonHeader: string;
        titleChooseFlavor: string;
        descriptionChooseFlavor: string;
        button: string;
        titleCakePops: string;
        descriptionCakePops: string;
        titleAboutMe: string;
        descriptionAboutMe: string;
        titleOurMenu: string;
        descriptionOurMenu: string;
        OurMenuSnikersTitle: string;
        OurMenuSkinkersDescription: string;
        OurMenuMeringueTitle: string;
        OurMenuMeringueDescription: string;
        OurMenuHoneyTitle: string;
        OurMenuHoneyDescription: string;
        OurMenuCupcakeTitle: string;
        OurMenuCupcakeDescription: string;
        home: string;
        gallery: string;
        shop: string;
        portfolio: string;
...
const HomePage: NextPage = () => {
    ...
    const translations: Translations = {
        ...
        // Добавьте переводы на других языках
    };
    return (
        <>
            <Nav selectedLanguage={selectedLanguage} handleLanguageChange={handleLanguageChange}
                 translations={translations}/>
            <Header selectedLanguage={selectedLanguage} translations={translations}/>
            <AboutMe selectedLanguage={selectedLanguage} translations={translations}/>
            <BestProduct/>
            <Review/>
            <ChooseFlavor selectedLanguage={selectedLanguage} translations={translations}/>
            <CakePops selectedLanguage={selectedLanguage} translations={translations}/>
            <OurMenu selectedLanguage={selectedLanguage} translations={translations}/>
            <GalleryCarousel/>
            <Footer/>
        </>
    )
